...
@ComponentScan("com.carsome.portal.persist")
@EnableJpaRepositories(basePackages = { "com.carsome.portal.persist.repo"},transactionManagerRef="transactionManager")
@PropertySource(value = { "classpath:carsome-portal.properties" })
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.carsome.portal.persist.*" });
