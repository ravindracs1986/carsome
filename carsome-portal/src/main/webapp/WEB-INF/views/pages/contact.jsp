	<div class="mail">
		<div class="container">
			...
			<div class="col-md-4 wthree_contact_left">
				...
				<ul>
					<li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> Phone :+ (60)3-3456782233</li>
					<li><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> Fax :+ (60)3-8755657575</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@carsome.com">info@carsome.com</a></li>
				</ul>
			</div>
